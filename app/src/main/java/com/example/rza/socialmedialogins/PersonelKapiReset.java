...
public class PersonelKapiReset extends AppCompatActivity implements NfcAdapter.CreateNdefMessageCallback, NfcAdapter.OnNdefPushCompleteCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personel_kapi_reset);

        Intent i = getIntent();
        personnelvalue = i.getExtras().getString("PersonnelNewValue");
